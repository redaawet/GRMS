...
# Additional models exposed in the admin for data management
admin.site.register(models.ConditionRating)
admin.site.register(models.ConditionFactor)
admin.site.register(models.InterventionLookup)
admin.site.register(models.UnitCost)
admin.site.register(models.PCULookup)
admin.site.register(models.NightAdjustmentLookup)
admin.site.register(models.BridgeDetail)
admin.site.register(models.CulvertDetail)
admin.site.register(models.FordDetail)
admin.site.register(models.RetainingWallDetail)
admin.site.register(models.GabionWallDetail)
admin.site.register(models.StructureConditionSurvey)
admin.site.register(models.BridgeConditionSurvey)
admin.site.register(models.CulvertConditionSurvey)
admin.site.register(models.OtherStructureConditionSurvey)
admin.site.register(models.FurnitureConditionSurvey)
admin.site.register(models.TrafficSurvey)
admin.site.register(models.TrafficCountRecord)
admin.site.register(models.TrafficCycleSummary)
admin.site.register(models.TrafficSurveySummary)
admin.site.register(models.TrafficQC)
admin.site.register(models.TrafficForPrioritization)
admin.site.register(models.StructureIntervention)
admin.site.register(models.RoadSectionIntervention)
admin.site.register(models.BenefitFactor)
admin.site.register(models.PrioritizationResult)
