(function () {
    ...
    ready(function () {
        var children = Array.from(document.querySelectorAll("[data-cascade-parent]"));
        if (!children.length) {
            return;
        }
